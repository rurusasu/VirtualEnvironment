...
wsl-setupは，wslのセットアップとUbuntu 20.04のインストールまでを行うシンプルなスクリプトで，これらは winget を用いることで同様のセットアップを行うことができます．wsl で使用する linux ディストリビューションの変更方法については、[WSL のインストール](https://docs.microsoft.com/ja-jp/windows/wsl/install) を参照してください。
